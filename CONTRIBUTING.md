...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/ITSS-Linux-System-Final-Project/typescript-node-express-boilerplate.git) section in README.md)
